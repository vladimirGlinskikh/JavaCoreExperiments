    ...
    public static void main(String[] args) {
        ...
        BiConsumer<Integer, Double> depositVerification = (x, y) -> {
            ...
            if (account != null
                ...
                System.out.println("DEPOSIT OF $" + y + " INTO ACCOUNT " + x + " SUCCESSFUL\n" + account);
            else
        ...
        BiConsumer<Integer, Double> withdrawVerification = (x, y) -> {
            ...
            if (account != null) {
                if (account.balance == (prevBalance - y))
                    ...
                    System.out.println("INSUFFICIENT FINDS TO"
                            + " WITHDRAW $" + y
                            + " FROM ACCOUNT " + x + "\n"
                            + account);
            } else
